    ...
    return (
        <div className='div_ppal'>
            ...
            <div className="contenedor-externo margen-superior">
                <div className="contenedor">
                    <h3 className="titulo">¿Por qué elegir CriptoApp para tu wallet?</h3>
                </div>
            </div>
            ...
            <div className="contenedor cuatro-columnas">
                ...
                <div className="ventaja-item">
                    <p className="ventaja-titulo">Trabaje con CriptoApp</p>
                    <p>¿Ya eres cliente de Coinbase? Vincula tu cuenta de CriptoApp a tu Wallet para acceder fácilmente a tus criptomonedas</p>
